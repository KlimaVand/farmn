...
namespace FarmN_2010
{
    ...
    public class FarmNWebService2010 : System.Web.Services.WebService
    {
        ...
        private int translateManureType(string ManureType)
        {
            ...
            {
                message.Instance.addWarnings("Problemer med databaseopslag for goedeningstype","Cannot find Manure Type " + ManureType,2);
            }
            if(ManureTypeInt==-1)
                message.Instance.addWarnings("Ukendt goedningstype","Cannot find Manure Type " + ManureType,2);
        ...
        private int translateSoilType(string soilType)
        {
            ...
            {
                message.Instance.addWarnings("Ukendt jordtype","Cannot find soiltype "+e.Message.ToString(),2);
            }
            return soilTypeInt;
        ...
        public List<error> errorMessages;
           ...
           /// </summary>
            public struct StandardRotation
            {
                ...
                public void setSedskifte(string sedskifte)
                {
                    this.ReferenceSedskifte=sedskifte;
                    this.Sedskifte=sedskifte;
                }
                ...
                {
                    return this.ReferenceSedskifte;
                }
                public string getSedskifte()
                {
                    return this.Sedskifte;
                }
