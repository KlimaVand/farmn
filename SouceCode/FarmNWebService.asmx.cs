...
{
    [WebService(Namespace = "http://172.20.107.138/FarmNWebservice",
                    Description = "Oprettelse og beregning af FarmN-scenarier. Webservice version 2.0 (2010)"
            )
    ]
    ...
    public class FarmNWebService : System.Web.Services.WebService
    {
        ...
        public FarmNWebService()
        {
            ...
            sqlconnstr = cfg.GetValue("sqlConnectionStringTestOld", typeof(string)).ToString();
        }
        ...
        public List<FarmNData> BeregnAnsoegtNy(List<Areal> arealer, List<Husdyrgodkendelse.Goedning.Goedningsmaengde> goedningsmaengder, long bedriftID, string zipCode, decimal afterCropPercent, decimal aNormPercent, bool option1, bool option2)
        {
            ...
            else
            {
                if (IsZipCodeValid(Convert.ToInt32(zipCode)))
                {
                    ...
                    if (option1 == true)
                    {
                        this.startASPPage(Convert.ToString("http://130.226.173.223/FarmNTest_original/CalculateResult.asp?version=1&farmNumber=" + Convert.ToString(aNewFarmNumber) + "&scenarioID=2&password=" + Convert.ToString(aNewFarmNumber) + "&normpercent=" + Convert.ToString(aNormPercent) + ""));
                    }
                    else
                    {
                        if (option2 == true)
                        ...
                        else
                        {
                            ...
                            this.startASPPage(Convert.ToString("http://130.226.173.223/FarmNTest_original/CalculateResult.asp?version=2&farmNumber=" + Convert.ToString(aNewFarmNumber) + "&scenarioID=2&password=" + Convert.ToString(aNewFarmNumber) + "&normpercent=" + Convert.ToString(aNormPercent) + ""));
                        }
                    ...
                    ////this.startASPPage(Convert.ToString("http://130.226.173.223/FarmNTest/CalculateResult.asp?farmNumber=" + Convert.ToString(aNewFarmNumber) + "&scenarioID=" + Convert.ToString(scenario) + "&password=" + Convert.ToString(aNewFarmNumber) + "&normpercent=" + Convert.ToString(aNormPercent) + ""));
                    //this.startASPPage(str);
        ...
        private int createVVMFarm(string DbId, out long aNewFarmNumber)
        {
